...
/**
 * Cette classe représente le panel qui permet de visionner les détails d'un produit
...
public class VisionnageProduitPanel extends JPanel implements ActionListener {
	...
	/**
	 * Création de tous les objets qui vont être affichés
	 * @param frame La frame dans laquelle se trouve le panel
	 * @param idUser l'identifiant de l'utilisateur qui est connecté
	 * @param isChefMagasin booléan qui nous précise si c'est un chef de magasin 
	 * @param idRayon l'identifiant du rayon dans lequel on se trouve
	 * @param idProduit l'identifiant du produit à afficher
	 */
	...
	/**
	 * Cette méthode regroupe tous les actions que vont effectuer les boutons
	 */
